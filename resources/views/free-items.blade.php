                    ...
                    <div class="item-demo">
                     <?php if($free_status=="yes"){?><div class="ribbon"><span><?php echo translate( 220, $lang);?></span></div><?php } ?>
                        <figure>
                            ...
                            <?php } else { ?>
                             <img src="<?php echo $url;?>/local/images/noimage.jpg" alt="Free Items">
                             <?php } ?>
                        ...
                        <div class="product-info">
                            <div class="product-header">
                                ...
                                <h3 class="product-name custom_tittle col-md-8 paddingoff homenew"><a href="<?php echo $url;?>/item/<?php echo $item_id;?>/<?php echo $views->item_slug;?>"><?php echo $views->item_title;?></a> </h3><span class="alink col-md-4 paddingoff text-right">
