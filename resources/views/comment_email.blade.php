...
<body>
	...
	<div class="container">
	 <h1><?php echo $site_name;?> - New comment received</h1>
	...
	font-weight: normal;line-height: 1.4em;color: #444;margin-top: 10px; padding:10px;">
			...
			<p> Name - <a href="<?php echo $url;?>/user/<?php echo $user_slug;?>"><?php echo $user_name;?></a></p> 	
			<p> Email - <?php echo $user_email;?></p> 
            <p> Item Link - <a href="<?php echo $url;?>/item/<?php echo $item_id;?>/<?php echo $item_slug;?>"><?php echo $url;?>/item/<?php echo $item_id;?>/<?php echo $item_slug;?></a></p> 	
			<p> Comment - <?php echo $comm_text;?></p> 
