...
<body>
	...
	<div class="container">
	 <h1><?php echo $site_name;?> - Forgot Password</h1>
	...
	font-weight: normal;line-height: 1.4em;color: #444;margin-top: 10px; padding:10px;">
            ...
            <div>
			<h2> Hello,</h2>
			<div style="font-size:16px;"><p> You are receiving this email because we received a password reset request for your account.
    ...
    transition: background 0.3s ease-in-out, color 0.3s ease-in-out; color:#fff; background:#22313F; text-decoration:none;">Reset Password</a>
				</p><br/><br/>
