                    ...
                    <?php if($free_status=="yes"){?><div class="ribbon"><span><?php echo translate( 220, $lang);?></span></div><?php } ?>
                        ...
                        <div class="product-info">
                            <div class="product-header">
                                ...
                                <h3 class="product-name custom_tittle col-md-8 paddingoff homenew"><a href="<?php echo $url;?>/item/<?php echo $texter;?>/<?php echo $views->item_slug;?>"><?php echo $views->item_title;?></a> </h3>
